      ...
      <footer className="bg-foreground text-background pt-16 pb-8 px-6 md:px-12">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="https://linkedin.com/in/mangrisky" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-background/70 transition-colors w-fit"><Linkedin className="w-4 h-4" /> LinkedIn</a>
          </div>
        </div>
